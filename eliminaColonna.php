<?php
	...
	$q="ALTER TABLE general_numbering DROP COLUMN [$nome]";
	...
	if($r==FALSE)
	{
		...
		$q=str_replace("*APICE*","'",$q);
		echo "<b style='color:red'>Error deleting column. Query: $q</b>";
		die();
	...
	{
		echo "<b style='color:green'>Colonna '$nome' eliminata</b>";
	}
	?>